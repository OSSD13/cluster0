...
class ExtrapointController extends Controller
{
    ...
    function add()
    {
        ...
        $year = Sprint::select('spr_year as year')
            ->distinct()
            ->get();

        $sprints = Sprint::select('spr_number as number')
            ->distinct()
            ->get();
    ...
    function edit()
    {
        ...
        $years = Sprint::select('spr_year as year')
            ->distinct()
            ->get();
    ...
    function store(Request $request)
    {
        ...
        try {
            ...
            $point->pts_value = $validated['point'];
            $point->save();
