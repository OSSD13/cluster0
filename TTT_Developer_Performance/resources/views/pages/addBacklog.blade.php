...
@section('contents')
    <div class="bg-white rounded-lg shadow-md p-6 shadow-lg">
        ...
        <div class="flex flex-wrap gap-4 mb-[30px] w-full max-w-[900px] mx-auto">
            <!-- Input Point All -->
            <div class="w-full sm:w-1/4">
                <label for="point_all" class="block mb-2 text-sm font-bold text-gray-900 dark:text-white">Point All <span class="text-red-500">*</span></label>
                <input type="text" id="point_all" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Point" required />
            </div>
            </div>
            ...
            <div class="flex flex-wrap gap-4 mb-[30px] w-full max-w-[900px] mx-auto">
            <div class="w-full sm:w-1/4">
                <label for="test_pass" class="block mb-2 text-sm font-bold text-gray-900 dark:text-white">Test Pass <span class="text-red-500">*</span></label>
                <input type="text" id="test_pass" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Test Pass" required />
            </div>
    
            <!-- Input Bug -->
            <div class="w-full sm:w-1/4">
                <label for="bug" class="block mb-2 text-sm font-bold text-gray-900 dark:text-white">Bug <span class="text-red-500">*</span></label>
                <input type="text" id="bug" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Bug" required />
            </div>
    
            <!-- Input Cancel -->
            <div class="w-full sm:w-1/4">
                <label for="cancel" class="block mb-2 text-sm font-bold text-gray-900 dark:text-white">Cancel <span class="text-red-500">*</span></label>
                <input type="text" id="cancel" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Cancel" required />
            </div>
        </div>
    
        <!-- Buttons -->
        <div class="flex flex-wrap gap-4 mb-[30px] w-full max-w-[900px] mx-auto">
            <button type="button" class="w-full sm:w-[350px] h-[60px] p-2 bg-zinc-500 text-white rounded-[10px] font-bold hover:bg-white hover:text-blue-900 hover:border-2 hover:border-blue-900">Cancel</button>
            <button type="submit" class="w-full sm:w-[350px] h-[60px] p-2 bg-blue-900 text-white rounded-[10px] font-bold hover:bg-white hover:text-blue-900 hover:border-2 hover:border-blue-900">Create</button>
        </div>
    </div>
@endsection
