...
@section('contents')
    ...
    <div class="flex flex-wrap gap-4 mb-[30px] w-full max-w-[900px] mx-auto">
        ...
        <button type="submit" class="w-full sm:w-[250px] h-[50px] p-2 bg-blue-900 text-white rounded-[10px] font-bold hover:bg-white hover:text-blue-900 hover:border-2 hover:border-blue-900">Apply</button>
    </div>
@endsection
