...
@section('contents')
    <div class="bg-white rounded-lg shadow-md p-8 max-w-4xl mx-auto">
        ...
        <!-- Form Container -->
        <form action="{{ route('updateExtraPoint') }}" method="POST">
            @csrf
            @method('PUT') <!-- แก้เป็น PUT เพื่อแสดงถึงการอัปเดตข้อมูล -->
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <select id="member" name="userID"
                            ...
                            <option value="" disabled selected class="text-center">Member</option>
                    ...
                    <div>
                        ...
                        <select id="current_team" name="teamID"
                            class="w-full p-2.5 text-sm font-bold text-blue-900 border border-blue-900 rounded-lg bg-gray-50 focus:ring-blue-900 focus:border-blue-900">
                            <option value="" disabled selected class="text-center">Team</option>
                    ...
                    <div>
                        ...
                        <select id="year" name="year"
                            class="w-full p-2.5 text-sm font-bold text-blue-900 border border-blue-900 rounded-lg bg-gray-50 focus:ring-blue-900 focus:border-blue-900">
                            <option value="" disabled selected class="text-center">Year</option>
                    ...
                    <div>
                        ...
                        <select id="sprint" name="sprint"
                            class="w-full p-2.5 text-sm font-bold text-blue-900 border border-blue-900 rounded-lg bg-gray-50 focus:ring-blue-900 focus:border-blue-900">
                            <option value="" disabled selected class="text-center">Sprint</option>
