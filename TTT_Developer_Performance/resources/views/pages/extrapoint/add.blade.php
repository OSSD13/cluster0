...
@section('contents')
    ...
    <!-- Buttons -->
    <div class="flex flex-wrap gap-4 mb-[30px] w-full max-w-[900px] mx-auto">
        <button type="button" class="w-full sm:w-[250px] h-[50px] p-2 bg-zinc-500 text-white rounded-[10px] font-bold hover:bg-white hover:text-blue-900 hover:border-2 hover:border-blue-900">Cancel</button>
        <button type="submit" class="w-full sm:w-[250px] h-[50px] p-2 bg-blue-900 text-white rounded-[10px] font-bold hover:bg-white hover:text-blue-900 hover:border-2 hover:border-blue-900">Create</button>
    </div>
@endsection
