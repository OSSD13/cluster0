...
@section('filter')
{{-- filter --}}
<div class="w-full h-15 bg-white border-gray-300 rounded-lg shadow-xl p-4 mb-[20px]">
    <div class="flex items-center justify-between text-xl font-bold text-[var(--primary-color)] mb-4">

        <!-- Filter label -->
        <div class="flex items-center">
            <img src="{{ asset('resources/Images/Icons/filter (1).png') }}" alt="Filter" class="w-5 h-5 mr-2">
            <p>Filter</p>
        </div>

        <!-- Dropdowns wrapper (Right-aligned) -->
        <div class="flex items-center gap-2 ml-auto">
            <!-- Team Dropdown -->
            <div class="relative">
                <button id="dropdownTeam"
                    class="border border-blue-900 text-blue-900 font-bold text-[12px] rounded px-3 py-1 bg-white flex items-center">
                    <span id="dropdownTeamSelected" class="truncate w-full">Team:</span>
            ...
            <div class="relative">
                <button id="dropdownYear"
                    class="border border-blue-900 text-blue-900 font-bold text-[12px] rounded px-3 py-1 bg-white flex items-center">
                    <span id="dropdownYearSelected" class="truncate w-full">Year:</span>
                    <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                    </svg>
            ...
            <div class="relative">
                <button id="dropdownSprint"
                    class="border border-blue-900 text-blue-900 font-bold text-[12px] rounded px-3 py-1 bg-white flex items-center">
                    <span id="dropdownSprintSelected" class="truncate w-full">Sprint:</span>
                    <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                    </svg>
...
<div class="my-2 flex flex-row gap-2 item-center w-full">
    <div class="basis-1/2 bg-white rounded-lg shadow-md shadow-lg">
        <div class="m-5">
            <p class="text-[var(--primary-color)] font-bold flex justify-start text-2xl m-5">Individual Point
                Details
            </p>
    ...
    <div class="basis-1/2 bg-white rounded-lg shadow-md shadow-lg">
        <div class="m-5">
            <p class="text-[var(--primary-color)] font-bold flex justify-start text-2xl m-5">Total Points by
                Individual
                in Team
            </p>
            <div class="relative overflow-x-auto sm:rounded-lg">
